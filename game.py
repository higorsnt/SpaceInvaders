...
class SpaceInvaders():
    def __init__(self):
        ...
        self.NAVE =  Nave(caminho_imagem_nave, (LARGURA_TELA) / 2, (ALTURA_TELA - 80) ) 
    ...
    def update(self):
        ...
        self.NAVE.update()
        self.TIRO.update()
        self.MATRIZ_DE_INIMIGOS.update()

        pygame.sprite.groupcollide(self.TIRO, self.MATRIZ_DE_INIMIGOS, True, True)
